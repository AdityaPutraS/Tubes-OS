...
echo Mulai kompilasi kernel, proc, dir, string
bcc -ansi -c -o proc.o proc.c
bcc -ansi -c -o dir.o dir.c
bcc -ansi -c -o string.o string.c
bcc -ansi -c -o kernel.o kernel.c
as86 kernel.asm -o kernel_asm.o
ld86 -o kernel -d kernel.o kernel_asm.o proc.o dir.o string.o
...
ld86 -o echoUtil -d echoUtil.o lib_asm.o dir.o string.o
./loadFile echoUtil

bcc -ansi -c -o mkdir.o mkdir.c
ld86 -o mkdir -d mkdir.o lib_asm.o dir.o
./loadFile mkdir

bcc -ansi -c -o ls.o ls.c
ld86 -o ls -d ls.o lib_asm.o dir.o
./loadFile ls

bcc -ansi -c -o cat.o cat.c
ld86 -o cat -d cat.o lib_asm.o dir.o string.o
./loadFile cat
